    ...
    <section>
      ...
      {showProdModal && (
        ...
        >
          ...
          <div className="input-group"><label className="input-label">{t('admin.fields.price')}</label><input className="input" type="text" inputMode="decimal" value={prodForm.base_price} onChange={e => setProdForm(product => ({ ...product, base_price: e.target.value }))} /></div>
      ...
      {showVarModal && (
        ...
        >
          ...
          <div className="input-group"><label className="input-label">{t('admin.fields.variantPrice')}</label><input className="input" type="text" inputMode="decimal" value={varForm.price_override} onChange={e => setVarForm(variant => ({ ...variant, price_override: e.target.value }))} /></div>
        </AdminModal>
      )}
