      ...
      <div className="container">
        ...
        {step === 1 && (
          <div style={{ marginTop: 18 }}>
            ...
            <div className="input-group"><label className="input-label">{t('checkout.fields.phone')}</label><input className="input" value={form.customer_phone} onChange={e => set('customer_phone', e.target.value)} type="tel" placeholder="+48 500 123 456" /></div>
            <div className="input-group"><label className="input-label">{t('checkout.fields.email')}</label><input className="input" value={form.customer_email} onChange={e => set('customer_email', e.target.value)} type="email" /></div>
